  ...
  return (
    <Container maxWidth="lg" className="home-container">
      ...
      <Box className="info-box" sx={{ mt: 5, py: 5 }}>
        ...
        <Typography variant="body1" component="p" gutterBottom>
          Dirígete a la página de denuncias, selecciona el tipo de denuncia que deseas hacer (correo, página web o teléfono), llena el formulario con la información requerida y envíalo.
        </Typography>
        <Typography variant="h5" component="h3" gutterBottom sx={{ mt: 4 }}>
          Página de Perfil
        </Typography>
        ...
        <Typography variant="body1" component="p" gutterBottom>
          En la sección "Mis Denuncias", puedes ver todas las denuncias que has enviado, su estado y detalles adicionales. Mantén un seguimiento de tus contribuciones.
        </Typography>
      </Box>
